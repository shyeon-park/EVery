						...
						<div class="row">
							<div class="col-6">
								<label for="title" class="form-label">제목</label> <input
									type="text" class="form-control" id="title" name="qna_title"
...
=======
>>>>>>> 1fd3c00f6d4615c2f820431ff964bd5c90ccd8c3
	<div class="footer">
	...
	<script>
		...
		$("#backBtn").on("click", function() {
			location.href = "${pageContext.request.contextPath}/admin/getClientSupport.do?view=qna";
		});
	</script>
	<script>
		$(function() {
