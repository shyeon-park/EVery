...
<body>
	<nav class="navber">
		<div class="row nav-items d-flex justify-content-center">
			...
			<div class="col-xl-1 d-none d-xl-block navi-menu">
				<a
					href="${pageContext.request.contextPath }/admin/toClientSupport.do">고객지원</a>
			</div>
			<c:choose>
								...
								<c:otherwise>
									<c:forEach items="${list}" var="dto">
										<tr class="infoList" style="text-align: center;">
											<td><a
												href="${pageContext.request.contextPath}/info/toDetail.do?seq_info=${dto.seq_info}">${dto.info_title}</a></td>
											<td>관리자</td>
